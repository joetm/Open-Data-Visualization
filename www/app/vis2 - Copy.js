/*global document, $, Papa, d3, console, alert, fields, progressbar, window, presidents, md*/
...
var c3_graph = {
    ...
    set_agency_timeseries: function (the_agency) {
        ...
        for (var i = 0, s = this.raw_data.length; i < s; i = i + 1) {
...
function assign_projects_to_agencies(data, president, template) {
    'use strict';
...
$(document).ready(function () {
    ...
    request.done(function (data) {
        ...
        presidents.obama.agencies = assign_projects_to_agencies(presidents.obama.projects, 'obama', agency_template);
        //var test = 0;
        ...
        presidents.bush.agencies = assign_projects_to_agencies(presidents.bush.projects, 'bush', agency_template);
...
$(document).ready(function () {
    ...
    president_containers.click(function () {
        ...
        presidents[graph.active_president].agencies = assign_projects_to_agencies(presidents[graph.active_president].projects, 'obama', agency_template);
